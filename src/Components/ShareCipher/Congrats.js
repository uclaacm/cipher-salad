...
function Congrats(props) {
    ...
    const plaintext = props.cipher[1];               // plaintext of the ciphered message
    const ciphertext = props.cipher[0];             // current guess at the deciphered message
    // load the described cipher.
    
    return (
        <div className="container center">
            <h1 className='title is-size-2 underline mt-4'>Are you the new cipher master?</h1>
